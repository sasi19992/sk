...
expirydate = datetime.date(2023, 10, 22)
...
def hero():
    ...
    while(y):
        ...
        print("Contact me on telegram @sasikumar")
...
if(expirydate>today):
    ...
    if (False):
        ...
        print(" admin on telegram @sasikumar ")
    ...
    print(" on telegram ----@sasikumar for activating")
